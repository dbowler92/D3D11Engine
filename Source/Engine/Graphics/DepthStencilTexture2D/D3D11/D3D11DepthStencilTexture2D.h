//D3D11DepthStencilTexture2D.h
//Created 10/07/17
//Created By Daniel Bowler
//
//Represents a single D3D11 depth/stencil texture
...
namespace EngineAPI
{
	namespace Graphics
	{
		namespace Platform
		{
			class D3D11DepthStencilTexture2D : public EngineAPI::Core::CoreObject
			{
			public:
				D3D11DepthStencilTexture2D() {};
				virtual ~D3D11DepthStencilTexture2D() = 0 {};

				//Inits the depth/stencil texture
				bool InitDepthStencilTexture2D(EngineAPI::Graphics::GraphicsDevice* device, 
				...
				//Shutsdown the depth/stencil texture
			...
			public:
				...
				//API Agnostic info
				DepthStencilTextureFormat GetDepthStencilTextureFormat() { return depthTextureFormat; };
